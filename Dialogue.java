    ...
    static final String chooseWorlds = 
        wrapText("C H O O S E               - Y O U R -               C H A R A C T E R")
              ...
              public static final String ENTRANCE_TEXT_1 = 
                  wrapText("As the air shimmers with magic, the scene shifts to a twilight glade, where beams of moonlight filter through the trees. A soft rustle breaks the silence, and a figure steps into view: the Fairy Godmother, her gown sparkling with stardust, her wand flickering like a tiny star. With a warm yet mischievous smile, she raises her wand, the air crackling with anticipation.");
